---
title: "Can I wax, peel, or do facials on a client taking Roaccutane?"
slug: can-i-wax-or-peel-a-client-on-roaccutane-uk
...
That medication note is health data under UK GDPR, so it needs to be stored securely, not on a sticky note or an open spreadsheet. Keeping a proper consultation record per client — what they're taking, when you asked, and what you declined — is exactly the kind of detail that protects you in a claim. SAY-OS keeps that history per client so you're never relying on memory when someone books.
