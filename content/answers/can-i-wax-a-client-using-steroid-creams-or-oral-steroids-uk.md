---
title: "Can I wax a client who uses steroid creams or takes oral steroids?"
slug: can-i-wax-a-client-using-steroid-creams-or-oral-steroids-uk
...
Record the answer with a date. Under UK GDPR that's health data, so it belongs in a secure client record — not a paper card or shared spreadsheet. A dated consultation note showing what you asked, what they said, and what you declined is what protects you if skin lifts and a claim follows. SAY-OS keeps that history on every client profile, so the flag is there the next time they book.
